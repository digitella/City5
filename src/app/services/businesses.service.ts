...
import { OrderBy } from '../common/constants';
...
export class BusinessesService {
  ...
  fetchBusinesses(filter: string, showFavorites: boolean, categoryId: string, orderBy: OrderBy = OrderBy.title): Promise<any[]> {
  ...
  getBusinessById(businessId: string) {
    return this.dataService.getBusinessById(businessId);
  }
